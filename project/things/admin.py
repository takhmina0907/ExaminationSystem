...
from .models import TestInfo, Question, Option, Student,StudentImage, TestResult, Answer
...
@admin.register(TestInfo, Question, Option, Student,StudentImage, TestResult, Answer)
