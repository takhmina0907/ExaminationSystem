...
from .models import TestInfo, Question, Option, Student, TestResult, Answer, Speciality
...
@admin.register(TestInfo, Question, Option, Student, TestResult, Answer, Speciality)
